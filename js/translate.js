    ...
    */				
        ...
        */
        addNodeQueueItem:function(uuid, node, word, attribute, lang, beforeText, afterText){
            ...
            if(translate.nodeQueue[uuid]['list'][lang][hash] == null || typeof(translate.nodeQueue[uuid]['list'][lang][hash]) == 'undefined'){
                ...
                translate.nodeQueue[uuid]['list'][lang][hash]['nodes'] = new Array();
                translate.nodeQueue[uuid]['list'][lang][hash]['original'] = word;
                translate.nodeQueue[uuid]['list'][lang][hash]['translateText'] = translate.nomenclature.dispose(word.trim()); //自定义术语处理
    ...
    /*
            ...
            getCharLanguage:function(charstr){
                ...
                if (!['chinese_simplified', 'english'].includes(translate.language.local)) {// 如果默认语言不是中文或者英文，就不用检查网站语言了
                    return translate.language.local;
                }
    ...
    */						
        ...
        */
        init:function(){
            ...
            // 不用请求服务器
            const data = {"result":1,"info":"成功","version":"3.2.3.20240403","serviceList":["translate.service","client.edge"]}
            //服务端返回的最新版本
    ...
    var nodeuuid = {
        index:function(node){
            ...
            if(typeof(node.tagName) == 'undefined'){
                ...
                childs = parent.querySelectorAll(CSS.escape(node.tagName));

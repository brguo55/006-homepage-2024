// Safety check: only run if jQuery is available
if (typeof $ === 'undefined') {
    console.warn('jQuery not available in time.js, skipping time display');
} else {
